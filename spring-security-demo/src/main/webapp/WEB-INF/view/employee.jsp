                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" placeholder="Sales Per Agent">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Basic Salary</label>
                                                <input type="text" class="form-control border-input" placeholder="Basic Salary">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" placeholder="Unpaid Days">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Basic Less Unpaid Days</label>
                                                <input type="text" class="form-control border-input" placeholder="Basic Less Unpaid Days">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" placeholder="GARNISHES + Late coming">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>COMMISSION</label>
                                                <input type="text" class="form-control border-input" placeholder="COMMISSION">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" placeholder="GROSS PAY">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>PAYE 6317+</label>
                                                <input type="text" class="form-control border-input" placeholder="PAYE 6317+">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>UIF</label>
                                                <input type="text" class="form-control border-input" placeholder="UIF">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>NET SALARY</label>
                                                <input type="text" class="form-control border-input" placeholder="NET SALARY">
                                            </div>
                                        </div>
                                    </div>
                                    <div class ="row">
